...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.react.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.react.security.DomainUserDetailsService", "createSpringSecurityUser");
